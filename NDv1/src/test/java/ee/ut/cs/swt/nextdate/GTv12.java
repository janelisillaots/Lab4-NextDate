...
public class GTv12 {
	...
	public void testCreatesNextDate15() throws Throwable {
	    NextDate nextDate0 = new NextDate(1982, 1982, 1982);
	    String string0 = nextDate0.run(8, 8, 1982);
	    assertEquals("8/9/1982", string0);
	}
	...
	public void testCreatesNextDate9() throws Throwable {
	    NextDate nextDate0 = new NextDate(1982, 1982, 1982);
	    String string0 = nextDate0.run(7, 7, 1982);
	    assertEquals("7/7/1982", string0);
	}
